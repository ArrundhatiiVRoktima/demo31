...
function submit(){
    ...
    else if(first_name_input.indexOf(' a') !== -1){
        console.log("Space");
    ...
    else if(first_name_input.indexOf(' b') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' c') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' d') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' e') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' f') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' g') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' h') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' i') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' j') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' k') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' l') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' m') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' n') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' o') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' p') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' q') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' r') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' s') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' t') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' u') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' v') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' w') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' x') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' y') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else if(first_name_input.indexOf(' z') !== -1){
        console.log("Space");
        alert("Please fill only your first name in the first-name input box. The middle name / last name is to be added in the last-name input box.")
    }
    else {
